...
\noindent Esta solução melhora significativamente a performance e a 
experiência do utilizador, evitando múltiplas requisições ao servidor 
e mantendo a lógica de filtragem simples e eficiente.

\subsection{Desenvolvimento da App frontend/MVC}
