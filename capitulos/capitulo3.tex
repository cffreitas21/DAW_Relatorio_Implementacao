...
Nesta secção são exibidos os StoryBoards de baixa fidelidade que 
demonstram o funcionamento geral da aplicação, desde o ecrã de login 
até à interação com os filmes e comentários.
São exibidos dois casos de uso principais para demonstrar o fluxo da aplicação 
de forma simples:
\begin{itemize}
...
\subsection{Interfaces do UC1 - Pesquisar Filme (Cinéfilo)}
\begin{figure}[H]
    \centering
...
\subsection{Interfaces do UC2 - Comentar Filme (Cinéfilo)}
\begin{figure}[H]
    \centering
...
\subsection{Interfaces do UC3 - Aprovar Comentários (Administrador)}
\begin{figure}[H]
    \centering
