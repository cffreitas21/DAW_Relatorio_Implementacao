...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/StoryBoards/StoryBoard_ComentarFilme.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/StoryBoards/StoryBoard_AnaliseDados.jpeg}
